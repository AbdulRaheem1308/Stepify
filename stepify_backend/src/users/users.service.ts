...
export class UsersService {
    ...
    async applyReferralCode(userId: string, referralCode: string) {
        ...
        await this.prisma.wallet.upsert({
            ...
            create: { userId: referrer.id, balance: REFERRAL_BONUS, lifetimePoints: REFERRAL_BONUS },
            update: {
    ...
    private async seedAvatars() {
        const avatars = [
            ...
            { url: 'https://api.dicebear.com/7.x/avataaars/png?seed=Willow', category: 'neutral' },
            { url: 'https://api.dicebear.com/7.x/bottts/png?seed=Robot', category: 'robot' },
            { url: 'https://api.dicebear.com/7.x/fun-emoji/png?seed=Happy', category: 'emoji' },
        ];
