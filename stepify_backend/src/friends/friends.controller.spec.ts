...
describe('FriendsController', () => {
  ...
  describe('getLeaderboard', () => {
    it('should return global leaderboard', async () => {
      const user = { id: 'u1' };
      (service.getGlobalLeaderboard as jest.Mock).mockResolvedValueOnce([{ id: 'u1' }, { id: 'u2' }]);
  ...
  describe('createInvitation', () => {
    it('should create invitation', async () => {
      const user = { id: 'u1' };
      await controller.createInvitation(user, { email: 't@t.com', phone: '123' });
      expect(service.createInvitation).toHaveBeenCalledWith('u1', 't@t.com', '123');
    });
  });
