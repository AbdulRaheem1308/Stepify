...
describe('StepsController', () => {
  ...
  it('should sync steps', async () => {
    const dto: SyncStepsDto = { deviceIdentifier: 'dev1', stepCount: 100, date: new Date().toISOString(), source: 'manual' };
  ...
  it('should get monthly summary without dates', async () => {
    ...
    expect(service.getMonthlySummary).toHaveBeenCalledWith('u1', undefined, undefined);
  });
