...
describe('OtpService', () => {
  ...
  describe('Initialization', () => {
    it('should initialize without twilio if missing config', () => {
      ...
      expect(warnSpy).toHaveBeenCalledWith('Twilio not configured - OTPs will be logged to console');
      warnSpy.mockRestore();
    });
    ...
    it('should log critical error in production if twilio missing', () => {
      ...
      expect(errorSpy).toHaveBeenCalledWith('CRITICAL: Twilio credentials missing or invalid in PRODUCTION mode! SMS OTPs will fail.');
