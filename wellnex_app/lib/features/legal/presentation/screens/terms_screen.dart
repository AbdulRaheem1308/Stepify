      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              '3. Rewards and Coins',
              'Wellnex provides in-app rewards ("WN Coins") based on your physical activity. These WN Coins hold no real-world monetary value and cannot be exchanged for fiat currency outside of the platform’s official redemption mechanisms. Accounts found cheating or spoofing location data will be permanently banned.',
            ),
            _buildSection(
