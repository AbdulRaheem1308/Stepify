...
/// ---------------------------------------------------------------------------
/// Stepify Flutter Unit & Widget Tests
/// ---------------------------------------------------------------------------
...
/// Wraps a widget in the providers Stepify requires (Riverpod + Material).
...
void main() {
  ...
  group('Widget Tests: Login Screen UI States', () {
    testWidgets('renders basic login UI elements without crashing', (tester) async {
      ...
      expect(find.text('Welcome to Stepify'), findsOneWidget);
