  ...
  Future<void> _shareInvite(String code) async {
    try {
      ...
      if (imageBytes != null) {
        ...
        final imagePath = await File('${directory.path}/stepify_invite.png').create();
        await imagePath.writeAsBytes(imageBytes);

        // 4. Create proper sharing message
        final message = '''
🚀 Join me on Stepify and get rewarded!
...
''';
  ...
  void _shareTextOnly(String code) {
    Share.share(
      'Join me on Stepify! Use code: $code\nhttps://stepify.app/invite?code=$code', 
      subject: 'Join Stepify!'
    );
  }
}
